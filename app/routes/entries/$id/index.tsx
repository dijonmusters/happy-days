    ...
    <Navigation />
      <div className="w-full flex flex-col items-center justify-center p-2">
        ...
        <div className=" w-full md:w-1/2 bg-white rounded border border-gray-200 shadow-sm m-4">
          <div className="p-5">
            <h5 className="mb-2 text-2xl font-bold text-blue-400">{entry.title}</h5>
            <p className="mb-2 font-normal text-gray-700">{entry.content}</p>
            <Link to="edit" className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-slate-600 rounded hover:bg-slate-800 focus:outline-none">
